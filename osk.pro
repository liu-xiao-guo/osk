...
UBUNTU_TRANSLATION_DOMAIN="osk.liu-xiao-guo"
...
aptest.commands = bash $$PWD/onscreenkeyboard/tests/autopilot/run
aptest.depends  = sub-onscreenkeyboard

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/onscreenkeyboard/tests/unit 
unittest.depends  = sub-onscreenkeyboard
